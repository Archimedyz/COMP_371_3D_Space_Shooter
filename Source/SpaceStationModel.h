...
#pragma once
#ifndef __COMP371_Framework__SpaceStationModel__
#define __COMP371_Framework__SpaceStationModel__
...
class SpaceStationModel : public Model
{
public:
    SpaceStationModel();
    ~SpaceStationModel();
    ...
    std::vector < glm:: vec3> get_varray() { return SpaceStationModel::vArray; }
protected:
...
#endif /* defined(__COMP371_Framework__SpaceStationModel__) */
